...
export class RespondToRequestDto {
  ...
  @ApiProperty({ 
    example: 'accepted', 
    enum: ['accepted', 'unavailable', 'declined', 'ignored'], 
    description: 'Statut de la réponse (accepted=Disponible, unavailable=Non Disponible, declined=Rejet)' 
  })
  @IsEnum(['accepted', 'unavailable', 'declined', 'ignored'])
  status: string;
