...
export class AiDoctorController {
  ...
  // ── POST /ai-doctor/chat ────────────────────────────────────────────────────
// Note : ce point de terminaison analyse tous les patients du médecin, mais la question doit être formulée de manière générale (pas de mention de patient spécifique).
  @Post('chat')
  @ApiOperation({
